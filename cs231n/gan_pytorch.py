...
def discriminator_loss(logits_real, logits_fake):
    ...
    loss = bce_loss(logits_real, torch.ones(logits_real.shape).squeeze().to(logits_real.device))
    loss += bce_loss(logits_fake, torch.zeros(logits_real.shape).squeeze().to(logits_fake.device))
...
def generator_loss(logits_fake):
    ...
    loss = bce_loss(logits_fake, torch.ones(logits_fake.shape).squeeze().to(logits_fake.device))
